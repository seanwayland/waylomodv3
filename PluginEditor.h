...
/**
*/
class Waylomod2020v3AudioProcessorEditor  : public juce::AudioProcessorEditor
{
public:
    Waylomod2020v3AudioProcessorEditor (Waylomod2020v3AudioProcessor&);
    ~Waylomod2020v3AudioProcessorEditor() override;
...
private:
    ...
    Waylomod2020v3AudioProcessor& audioProcessor;
    // This reference is provided as a quick way for your editor to
    // access the processor object that created it.
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Waylomod2020v3AudioProcessorEditor)
};
