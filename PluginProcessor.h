...
/**
*/
class Waylomod2020v3AudioProcessor  : public juce::AudioProcessor
{
public:
    //==============================================================================
    Waylomod2020v3AudioProcessor();
    ~Waylomod2020v3AudioProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Waylomod2020v3AudioProcessor)
};
